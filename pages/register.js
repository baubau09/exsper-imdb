                    ...
                    <section className="mt-10">
                        <Form className="flex flex-col">
                            <div className="mb-6 pt-3 rounded bg-gray-200">
                                <label className="block text-gray-700 text-sm mb-2 ml-3" for="name">Name</label>
                            ...
                            <div className="mb-6 pt-3 rounded bg-gray-200">
                                ...
                                className="block mb-2 ml-3 rounded focus:outline-none border-b-4  focus:border-primary-500 w-2/4">
